...
void GeneratorHistorii::addAdjective()
{
	...
	adjective.push_back("Tajemniczy");
	adjective.push_back("Groüny");
	adjective.push_back("Ponury");
	adjective.push_back("Magiczny");
...
void GeneratorHistorii::addWhoRule()
{
	...
	whoRule.push_back("byl silniejszy");
	whoRule.push_back("byl sprytniejszy");
	whoRule.push_back("byl bezwzgledny");
...
void GeneratorHistorii::addDiplomacy()
{
	...
	diplomacy.push_back("w pokoju ");
	diplomacy.push_back("w kruchym pokoju ");
	diplomacy.push_back("w kruchym sojuszu ");
...
void GeneratorHistorii::addKingdoms()
{
	...
	kingdoms.push_back("Ksiestwo Naggeri");
	kingdoms.push_back("Krolestwo Czlowieka");
	kingdoms.push_back("Hetmanat Bihun");
	kingdoms.push_back("Sultanat PraHun");
}
