...
int main()
{
	MainGameCharacter player("Gerwant", GameCharacterRace::Human, 
		GameCharacterClass("Witcher",{new Ability("Whirl",AbilityType::Offensive,691,Effect("Bleed",1,0))}),
		Statistics(10, 10, 10, 10, 10, 10),
		Alignment::Neutral, 100, 100, {new Weapon("Aerodnight",1000,2107,100)}, 1, "Gerwant");
}
